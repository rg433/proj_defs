effect effects/ambient/road_flare_purple
{
	size	125
	...
	emitter "flare"
	{
		...
		line
		{
			...
			start
			{
				...
				size { point 0.5 }
				tint { point 0.803922,0.792157,1 }
				length { point 6,0,0 }
			}
	...
	emitter "sparks_lines"
	{
		...
		line
		{
			...
			start
			{
				...
				size { box 0.5,1 }
				tint { line 0.835294,0.85098,1,0.368627,0.384314,1 }
	...
	emitter "steam1"
	{
		...
		sprite
		{
			...
			start
			{
				...
				tint { line 0.501961,0.501961,1,0,0.501961,1 }
				fade { point 0 }
