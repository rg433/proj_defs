effect effects/vehicles/explosion_tank
{
	size	1715
	...
	spawner "smoke3"
	{
		...
		sprite
		{
			...
			start
			{
				...
				velocity { box 0,-800,-800,0,800,800 }
	...
	spawner "MAIN BODY DB"
	{
		...
		debris
		{
			duration	1,1
			persist
			entityDef	"debris_tank_turret"

			start
			{
				position { sphere 300,-10,-10,300,10,10 surface }
				velocity { box 1000,-200,-200,2000,200,200 }
			}
