effect effects/vehicles/explosion2
{
	size	1314
	...
	spawner "joint debris"
	{
		...
		debris
		{
			...
			start
			{
				...
				velocity { box 2000,200,-1000,1000,-500,1000 }
			}
	...
	spawner "MAIN BODY DB"
	{
		...
		debris
		{
			...
			{
				position { sphere 100,-10,-10,100,10,10 surface }
				velocity { box 500,-2000,-2000,3000,-2000,2000 }
			}
	...
	spawner "rocket launcher"
	{
		...
		debris
		{
			...
			{
				position { sphere 100,-10,-10,100,10,10 surface }
				velocity { box 500,-2000,-3000,1000,-2000,3000 }
			}
