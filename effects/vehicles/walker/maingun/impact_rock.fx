effect effects/vehicles/walker/maingun/impact_rock
{
	size	1002
	...
	spawner "dirt_up"
	{
		...
		sprite
		{
			...
			start
			{
				...
				velocity { box 100,-100,-100,800,100,100 }
	...
	spawner "dirt_up3"
	{
		...
		{
			duration	1,1.5
			material	"gfx/effects/particles_shapes/debri_2"
			gravity		0.3,0.4
