effect effects/monsters/harvester/part_explosion_arm
{
	size	566
	...
	spawner "column_fire"
	{
		...
		sprite
		{
			...
			start
			{
				position { cylinder -50,-50,-50,50,50,50 linearSpacing }
	...
	emitter "unnamed13"
	{
		...
		{
			duration	1,1
			entityDef	"debris_harvester_arm1"
	...
	emitter "unnamed14"
	{
		...
		{
			duration	1,1
			entityDef	"debris_harvester_arm2"
	...
	emitter "unnamed16"
	{
		...
		{
			duration	1,1
			entityDef	"debris_harvester_hook"
