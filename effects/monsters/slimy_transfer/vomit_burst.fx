effect effects/monsters/slimy_transfer/vomit_burst
{
	size	327
	...
	emitter "smoke"
	{
		...
		sprite
		{
			...
			start
			{
				...
				size { line 6,6,10,10 }
				tint { line 0.541176,0.619608,0.0941177,0.227451,0.0470588,0.0470588 }
				fade { point 0 }
	...
	emitter "bubbles2"
	{
		...
		oriented
		{
			...
			start
			{
				...
				size { point 0,0 }
				tint { line 0.411765,0.0784314,0.0784314,0.654902,0.74902,0.113725 }
			}
	...
	spawner "mflash1"
	{
		...
		line
		{
			...
			start
			{
				...
				size { point 10 }
				tint { line 0.654902,0.74902,0.113725,0.454902,0.0784314,0.0784314 }
			}
	...
	spawner "smoke2"
	{
		...
		sprite
		{
			...
			start
			{
				...
				size { line 6,6,10,10 }
				tint { line 0.47451,0.486275,0.247059,0.341176,0.168627,0.168627 }
				fade { point 0 }
				rotate { box 0,1 }
			}
	...
	spawner "unnamed12"
	{
		...
		sprite
		{
			...
			start
			{
				...
				size { point 20,20 }
				tint { line 0.654902,0.74902,0.113725,0.411765,0.0784314,0.0784314 }
			}
