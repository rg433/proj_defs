effect effects/monsters/hornet/explosion2
{
	size	1182
	...
	spawner "engine"
	{
		...
		{
			duration	0.5,0.5
			entityDef	"debris_hornet_engine"

			start
			{
				position { cylinder -50,-50,-50,50,50,50 surface }
			...
			{
				rotate { box 0,-16.6667,-16.6667,0,16.6667,16.6667 }
			}
		}
	}
	spawner "leg1"
