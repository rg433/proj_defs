effect effects/explosions/surface/tramcar_exp
{
	size	2186
	...
	spawner "unnamed13"
	{
		...
		{
			duration	1,1
			entityDef	"debris_tram_base"
			gravity		1,1

			start
			{
				position { point 50,0,-200 }
	...
	spawner "unnamed14"
	{
		...
		{
			duration	1,1
			entityDef	"debris_tram_arm"
			gravity		1,1

			start
			{
				position { point 30,0,-200 }
				velocity { box 1000,-2000,-2000,2000,2000,2000 }
			}
	...
	spawner "unnamed15"
	{
		...
		{
			duration	1,1
			entityDef	"debris_tram_shield"
			gravity		1,1

			start
			{
				position { line 30,-50,-200,30,50,-200 }
				velocity { box -1000,-2000,-2000,1000,2000,2000 }
			}
			...
			{
				rotate { box -6.94444,-6.94444,-6.94444,6.94444,6.94444,6.94444 }
			}
		}
	}
	spawner "unnamed16"
	{
		...
		{
			duration	1,1
			entityDef	"debris_tram_sleeve"
			gravity		1,1

			start
			{
				position { line 30,-60,-300,30,60,-300 }
	...
	sound "unnamed15"
	{
		soundShader	"tram_tramcar_explode1"
		freqshift	0.8,0.8
	}
	sound "unnamed16"
	{
		soundShader	"tram_tramcar_explode2"
		freqshift	1.2,1.2
	}
}
