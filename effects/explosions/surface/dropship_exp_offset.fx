effect effects/explosions/surface/dropship_exp_offset
{
	size	4543
	...
	spawner "fire2"
	{
		...
		sprite
		{
			...
			end
			{
				...
				fade { point 1 }
				offset { box 300,-600,-600,300,600,600 }
			}
		}
	}
	sound "unnamed10"
