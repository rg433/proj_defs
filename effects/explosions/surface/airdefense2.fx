effect effects/explosions/surface/airdefense2
{
	size	2007
	...
	spawner "side_dirt_streaks"
	{
		...
		line
		{
			...
			start
			{
				...
				size { box 30,35 }
				tint { line 0.392157,0.34902,0.25098,0.282353,0.254902,0.184314 }
				fade { point 0 }
				offset { point 20,0,0 }
	...
	spawner "residual_smoke"
	{
		...
		sprite
		{
			...
			start
			{
				position { line -20,-30,-30,150,30,30 }
