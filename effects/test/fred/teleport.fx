effect effects/test/fred/teleport
{
	size	330
	...
	emitter "orbit"
	{
		...
		sprite
		{
			duration	3,3
			blend	add
			material	"gfx/effects/energy_sparks/teleport_base4"
			generatedOriginNormal
			trailType	orbit2

			start
			{
				position { line 0,0,0,2,0,0 }
				angle { box 0,0,0,0,0,1 }
				size { line 2,2,4,4 }
				offset { box 0,-60,0,0,60,0 }
	...
	trail "orbit2"
	{
		...
		sprite
		{
			...
			{
				size { point 2,2 }
				tint { line 1,1,1,0.729412,1,0.729412 }
				rotate { box 0,0.0333333 }
			}
	...
	spawner "teleportringmove"
	{
		...
		oriented
		{
			...
			{
				size { envelope linear }
				fade { envelope pop_hold_fade offset 0.45 }
				rotate { envelope linear }
			}
