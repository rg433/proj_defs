effect effects/mp/jumppad_trigger_green
{
	size	409
	...
	spawner "unnamed1"
	{
		...
		sprite
		{
			...
			start
			{
				...
				tint { point 0.101961,0.313726,0.0470588 }
				fade { point 0 }
	...
	spawner "unnamed2"
	{
		...
		sprite
		{
			...
			start
			{
				...
				tint { point 0.105882,0.427451,0.129412 }
				fade { point 0 }
				rotate { box 0,1 }
			}
	...
	spawner "unnamed3"
	{
		...
		sprite
		{
			...
			start
			{
				...
				tint { point 0.0156863,0.243137,0.0901961 }
				fade { point 0 }
				rotate { box 0,1 }
			}
