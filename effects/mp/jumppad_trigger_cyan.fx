effect effects/mp/jumppad_trigger_cyan
{
	size	409
	...
	spawner "unnamed1"
	{
		...
		sprite
		{
			...
			start
			{
				...
				tint { point 0.0156863,0.219608,0.243137 }
				fade { point 0 }
	...
	spawner "unnamed2"
	{
		...
		sprite
		{
			...
			start
			{
				...
				tint { point 0.0862745,0.337255,0.380392 }
				fade { point 0 }
				rotate { box 0,1 }
			}
	...
	spawner "unnamed3"
	{
		...
		sprite
		{
			...
			start
			{
				...
				tint { point 0.027451,0.129412,0.294118 }
				fade { point 0 }
				rotate { box 0,1 }
			}
