effect effects/mp/jumppad_trigger_yellow
{
	size	409
	...
	spawner "unnamed1"
	{
		...
		sprite
		{
			...
			start
			{
				...
				tint { point 0.313726,0.305882,0.0470588 }
				fade { point 0 }
	...
	spawner "unnamed2"
	{
		...
		sprite
		{
			...
			start
			{
				...
				tint { point 0.427451,0.388235,0.105882 }
				fade { point 0 }
				rotate { box 0,1 }
			}
	...
	spawner "unnamed3"
	{
		...
		sprite
		{
			...
			start
			{
				...
				tint { point 0.247059,0.113725,0.0117647 }
				fade { point 0 }
				rotate { box 0,1 }
			}
