effect effects/mp/ctf_orange_holo
{
	size	346
	...
	emitter "thelight"
	{
		...
		line
		{
			duration	1,1
			blend	add
			material	"gfx/effects/energy_sparks/ctf_flag_light_strogg"
	...
	emitter "rings1"
	{
		...
		oriented
		{
			duration	2,10
			blend	add
			material	"gfx/effects/energy_sparks/ctf_flag_ring_strogg"
	...
	emitter "unnamed3"
	{
		...
		oriented
		{
			duration	1,1
			blend	add
			material	"gfx/effects/energy_sparks/teleport_base3_strogg"
	...
	emitter "spirals"
	{
		...
		sprite
		{
			duration	0.5,1.5
			blend	add
			material	"gfx/effects/energy_sparks/spark3_strogg"
			gravity		-0.16,0
			trailType	burn
			trailTime	0.5,0.5
			trailCount	25,25
